...
obj.delCheck = function(voteObj){
	...
	var yestodyStart = new Date('2014/11/22 00:00:00') //(moment().hour(0).minute(0).second(0).unix() - intervalHour)*1000;
	var yestodyEnd = new Date('2014/11/22 23:59:59')//(moment().hour(23).minute(59).second(59).unix() - intervalHour)*1000;
