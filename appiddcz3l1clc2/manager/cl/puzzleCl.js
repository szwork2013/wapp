var Dl = require('../dl/puzzleDl.js');
var utils = require('../../lib/utils.js');
var obj = {}
obj.list = function(req, res){
	res.render('puzzle_list', {session:req.session});
}
...
obj.update = obj.create  = function(req, res){
	...
	req.models[0]["puzzles"] = req.models[0]["puzzles"].split(',');
...
obj.getPuzzleList = function(req, res){
