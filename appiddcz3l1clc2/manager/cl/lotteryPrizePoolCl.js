var Dl = require('../dl/lotteryPrizePoolDl.js');
var utils = require('../../lib/utils.js');
var obj = {}
obj.list = function(req, res){
	res.render('lottery_prize_pool_list', {session:req.session});
}
...
obj.update = obj.create  = function(req, res){
	...
	if(req.models[0]["detail"]){
		try{
			req.models[0]["detail"] = JSON.parse(req.models[0]["detail"])
		}
		catch(e){
			return res.send(e);
		}
